...
def draw_terrain(screen,font):
    W,H,hills,LAYERS,CENTERS,BASE_RADIUS,LAYER_GAP,NOISE_FREQ,NOISE_AMP=cf.W,cf.H,cf.hills,cf.LAYERS,cf.CENTERS,cf.BASE_RADIUS,cf.LAYER_GAP,cf.NOISE_FREQ,cf.NOISE_AMP
